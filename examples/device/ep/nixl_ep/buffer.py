...
class Buffer:
    ...
    def get_configured_proxy_channels(self) -> int:
        ...
        return int(self.runtime.get_configured_proxy_channels())

    def get_proxy_worker_count(self) -> int:
        """Return the configured proxy worker count for this buffer."""
        return int(self.runtime.get_proxy_worker_count())
